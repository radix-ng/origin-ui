...
@Component({
    selector: 'demo-button-121',
    imports: [OriButton],
    template: `
        <div class="flex flex-col gap-2">
            <button variant="outline" oriButton>
                <svg
                    class="remixicon me-3 text-[#DB4437] dark:text-white/60"
                    viewBox="0 0 24 24"
            ...
            <button variant="outline" oriButton>
                <svg
                    class="remixicon me-3 text-[#14171a] dark:text-white/60"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
            ...
            <button variant="outline" oriButton>
                <svg
                    class="remixicon me-3 text-[#1877f2] dark:text-white/60"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
            ...
            <button variant="outline" oriButton>
                <svg
                    class="remixicon me-3 text-[#333333] dark:text-white/60"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
...
export default class Button121Component {}

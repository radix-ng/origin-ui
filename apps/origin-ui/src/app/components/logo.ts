        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="117" height="24" fill="none">
            ...
            <g filter="url(#a)">
                <path
                    fill="url(#b)"
                    fill-rule="evenodd"
                    d="M11.371 22.743c6.28 0 11.372-5.091 11.372-11.372C22.743 5.091 17.652 0 11.37 0 5.091 0 0 5.091 0 11.371s5.091 11.372 11.371 11.372Zm0-5.825a5.547 5.547 0 1 0 0-11.094 5.547 5.547 0 0 0 0 11.094Z"
                    clip-rule="evenodd"
                />
            </g>
            <defs>

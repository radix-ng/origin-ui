        ...
        <main>
            <div class="px-4 sm:px-6">
                <div class="mx-auto w-full max-w-6xl">
                    <app-components-page-header title="Badge">
                        A growing collection of {{ totalComponents }} badge components built with Angular and
                        TailwindCSS.
...
export default class PageBadgesComponent {
    badgeDir = 'badges';
    badgeFiles = [
        'badge-01',
        'badge-02',
    ...
    totalComponents = this.badgeFiles.length;
}
